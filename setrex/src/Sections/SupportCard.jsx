...
const SupportCard = () => {
  ...
  return (
    <section id="Support-card" className="flex justify-center bg-bgprimary lg:pt-[160px] pt-[72px] px-[16px]">
      ...
      <div id="main" className=" flex flex-col z-2   lg:p-[20px] mx-[20px] mx-auto max-width[92%] lg:max-w-[85%] w-full">
        ...
        <div id='heading_wrapper' className="items-center flex justify-center items-center   ">
          <h2 className=" text-center  big-text text-2xl sm:text-4xl md:text-5xl leading-tight max-w-[75%] lg:max-w-[45%]  ">
      ...
      <SectionReveal>
        ...
        <div className=" mx-auto items-cnenter lg:flex-row flex-col  justify-center lg:mt-[80px] mt-[40px] flex gap-[12px]  bg-bgprimary " id="card-content" >
          ...
          {/* Left section */}
          <div id="left-section " className="bg-[#1f1f23] lg:p-[60px] px-[20px] py-[24px] text-[24px]  h-full rounded-3xl w-full max-w-full lg:max-w-[60%]">
            <div id="upper-left" className="flex items-start flex-col gap-[20px] lg:gap-[30px]">
              <Label label="CEO's Words" bgcolor="#f3ff9b" />
              <h4 className="text-tertiary font-medium text-mbsm lg:text-2xl lg:leading-9 leading-7">
            ...
            <div id="lower-left" className="  flex mt-[32px] lg:mt-[60px] justify-between items-center gap-[20px]">
              ...
              <div className="flex flex-start items-center gap-[10px] lg:gap-[12px] ">
                ...
                <div>
                  ...
                  <div className="text-tertiary lg:text-[24px] text-[16px]" >Co Founder of metrilo</div>
                </div>
              </div>
          ...
          <div id="right-section" className="flex flex-col  md:flex-row lg:flex-col  gap-[12px]">
            {/* upper */}

            <div className="z-2 flex flex-col flex-1 justify-between rounded-3xl bg-[#1f1f23] px-[20px] lg:px-[26px] py-[20px] gap-[16px]">
            ...
            {/* lower */}
            <div className="z-2 flex flex-col flex-1 justify-between rounded-3xl bg-[#1f1f23] px-[20px] px-[26px] py-[20px] gap-[16px]">
